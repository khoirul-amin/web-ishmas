...
?>
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Visi & Misi Sekolah</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
  ...
  <script>
        ...
        function getData(){
            $('#example1').DataTable({
                ...
                ajax:{
                    url: "<?php echo base_url("Admin/VisiMisi/get_datatables");?>",
                    type: "POST",
                    cache: false,
                },
            });

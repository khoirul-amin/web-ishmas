    ...
    <div class="container">
        ...
        <div class="row ml-0 mr-0 mt-3">
            <div class="col-sm-8 p-0">
                <div class="header-box">Berita Seputar MTs Ishlahul Masalik</div>
                <?php 
                ...
                ?>
                    <div class="box-right-content">
                        ...
                        <a href="/Home/viewBerita/<?=$informasi->id?>">(Baca Selengkapnya)</a></div>
                    </div>
                <?php   } ?>
            ...
            <div class="col-sm-4 cp">
                <div class="header-box">Berita Terbaru</div>
                <div class="box-right-content">
                <?php
                    $limit = 0;
                ...
                ?>
                    ...
                    <p> <i class="fas fa-calendar"></i> <?=$informasi->created_at?><br/>
                        <a href="/Home/viewBerita/<?=$informasi->id?>">(Baca Selengkapnya)</a></p>
                <?php
                    $limit++;
                    if($limit == 9){
                        break;
